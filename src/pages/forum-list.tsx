...
import ForumPage, { type ForumInitialData } from "@/app/forum/page";
import { getPosts, getCategories } from "@/lib/forum/api/client";
 ...
 */
export async function loader({ request }: LoaderFunctionArgs): Promise<ForumInitialData> {
