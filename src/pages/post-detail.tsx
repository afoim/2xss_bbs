...
import ForumPostPage from "@/app/forum/post/page";
import type { PostInitialData } from "@/app/forum/post/post-content";
import { PostToc } from "@/components/post-toc";
import { buildToc } from "@/lib/build-toc";
import { getPost, getComments, buildCommentTree } from "@/lib/forum/api/client";
import { parseCommentSort } from "@/lib/forum/api/map-comment";
import { loadRenderer } from "@/lib/forum/markdown-client";
import { useSeo } from "@/lib/seo/use-seo";
import { SITE_URL, canonicalPath, makeExcerpt } from "@/lib/seo/route-meta";
 ...
 */
export async function loader({ params, request }: LoaderFunctionArgs): Promise<PostInitialData> {
