...
export const SITE_TITLE = "二叉树树论坛";
export const SITE_URL = (import.meta.env.VITE_SITE_URL || "https://bbs.acofork.com").replace(/\/+$/, "");
export const SITE_DESCRIPTION =
  "二叉树树论坛：技术交流与闲聊灌水社区，支持 Markdown 发帖、评论与点赞，欢迎注册加入讨论。";
export const DEFAULT_OG_IMAGE =
  import.meta.env.VITE_OG_IMAGE || "https://2x.nz/files/img/official.png";
